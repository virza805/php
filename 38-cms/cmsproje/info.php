...
// php artisan make:migration add_nickname_field_to_users_table |=> for new table colum in database
// php artisan make:migration add_avatar_field_to_users_table |=> for new table colum in database
