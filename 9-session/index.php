...
if('edit' == $task){
    if(!hasPrivilege()){
        header( 'location: /9-session/index.php?task=report' );
        return;
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="/9-session/inc/style.css">
    <style>
        body {
            margin-top: 30px;
        }
...
<div class="container">
    ...
    <?php if ( 'add' == $task ): ?>
        <div class="row">
            <div class="column column-60 column-offset-20">
                <form action="/9-session/index.php?task=add" method="POST">
